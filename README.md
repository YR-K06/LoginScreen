...
- 과제 내용
 - Label 컨트롤 추가
 -Visible 속성 이용해서 메시지 보이기와 숨기기 기능 구현

- 구현 내용과 기능 설명
 - 아이디와 패스워드 입력창 아래에 Label 컨트롤 추가
 -아이디와 패스워드 입력 후 틀렸을 때 lalErrorMsg Visible = true로 설정해서 메시지 보이게 하기
 -아이디와 패스워드 입력 후 맞았을 때 lalErrorMsg Visible = false로 설정해서 메시지 숨기기
 - 로그인 실패 시 메시지 박스 대신 Label 컨트롤로 메시지 보여주기
...
- 과제 내용
 ...
 - 아이디 입력 후 Enter키 치면 패스워드 입력 창으로 넘어가기
 - 패스워드 입력 후 Enter키 치면 로그인 시작
 -전체를 지우는 기능
 -패스워드를 보여주는 기능

- 구현 내용과 기능 설명
 - 로그인 창에서 Enter키 입력 시 패스워드 창으로 포커스 이동하도록 설정
 -패스워드 창에서 Enter키 입력시 버튼 클릭 이벤트 발생하도록 설정
